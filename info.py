...
BOT_TOKEN = environ.get('BOT_TOKEN', "8802451847:AAENlXzwvmnwUYNelAULqYESuTjm7nbz5tQ")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/vo0jgi.jpg')).split()  # Sample pic
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004476703438'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-100'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004368657869'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1004343096190")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1004476703438'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinema_nyx') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/cinema_nyx') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/cinema_nyx') # Update channel link for the bot
